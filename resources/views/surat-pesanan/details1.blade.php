                            ...
                            <table class="table table-hover table-sm bg-light table-striped table-bordered" id="table">
                                ...
                                <tbody class="input-fields">
                                    <tr>
                                            ...
                                            <div class="form-group col-12">
                                                <select name="inputs[0][part_no]" class="form-control mr-2 my-select" id="package-default" onchange="updateData(`default`)">
                                                    ...
                                                    @foreach($master_part as $k)
                                                        <option value="{{ $k->part_no }}" data-het="{{ $k->het }}" data-stok="{{ $k->stok_gudang->stok }}"> {{ $k->part_no }} | {{ $k->part_nama }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <div class="form-group col-12">
                                                <input type="text" name="stok" for="stok" id="stok-default" class="form-control" readonly>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div class="form-group col-12">
...
@section('script')
    <script>
        ...
        $('#add').click(function(){
            ...
            $('#table').append(`<tr>
                ...
                <td class="text-center">
                    <div class="form-group col-12">
                        <input type="text" id="stok-${i}" name="stok" for="stok" class="form-control" readonly>
                    </div>
                </td>
                <td class="text-center">
                    <div class="form-group col-12">
    ...
    function updateData(i){
        ...
        const stok = $(`#package-${i} option:selected`).data('stok');

        const formattedHet = Number(het).toLocaleString('id-ID');
        const formattedStok = Number(stok).toLocaleString('id-ID');

        $(`#het-${i}`).val(formattedHet);
        $(`#stok-${i}`).val(formattedStok);
    }
