    ...
    <div class="row mt-5">
        <div class="col-lg-12 pb-3">
             <div class="float-left">
                <h4><b>Master Group</b></h4>
            </div>
            <div class="float-right">
                <a class="btn btn-success" href="{{ route('part-group.create') }}"><i class="fas fa-plus"></i> Tambah Part</a>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-lg-12">  
                        <table class="table table-hover table-bordered table-sm bg-light table-striped" id="example1">
                            ...
                            <tbody>
                                ...
                                @foreach($part_group as $p)
                                <tr>
                                    <td class="text-center">{{ $no++ }}</td>
                                    <td class="text-center">{{ $p->group_part }}</td>
