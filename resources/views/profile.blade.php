...
<html lang="en">
  ...
  <header id="header" class="header">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <a class="navbar-brand" href="#">
        <img src="{{ asset('dist/img/new-logo.png')}}" width="50" height="50" alt="" class="img-fluid img-logo-navbar">
      </a>
    ...
    <div class="pt-3 pb-5">
      <div class="row">
        <div class="col-lg-6 col-sm-7 text-left">
          ...
          <p>PT. Kumala Central Partindo adalah Distributor Resmi Suku Cadang motor serta mobil Aspira dan Federal dari PT. Astra Otoparts</p>
          <a type="button" href="" class="btn btn-primary btn-lg">Beli Sekarang</a>  
        </div>
        <div class="col-lg-6 order-sm-2">
          <div>
            <img class="img-fluid" src="{{asset('dist/img/dashboard.png')}}" alt="">
          </div>
        </div>
      </div>    
    </div>
    ...
    <div class="container text-left p-3">
      <div style="padding-left: 10px; padding-right: 10px;">
        ...
        <div style="color: #dcdddc;">
          <h6>Pendaftaran dapat dilakukan untuk toko yang sudah melakukan pengajuan melalui Team Marketing PT. KCP</h6>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-md">
        <div class="card shadow p-3 mb-5 bg-white rounded" style=" height: 300px;">
          <img class="card-img-top mx-auto" src="{{ asset('dist/img/shopping.png') }}"  style="width: 50px;">
          <div class="card-body">
            <h5 class="card-title text-center">ONLINE SHOP</h5>
            <p class="card-text text-center">Berisi informasi mengenai ketersediaan barang yang dijual oleh PT. KCP 
      ...
      <div class="col-md">
          <div class="card shadow p-3 mb-5 bg-white rounded"  style=" height: 300px;">
            <img class="card-img-top mx-auto" src="{{ asset('dist/img/search.png') }}" style="width: 50px;">
            <div class="card-body">
              <h5 class="card-title text-center">INFORMASI PENGAJUAN TOKO BARU</h5>
              <p class="card-text text-center">Halaman ini dapat
      ...
      <div class="col-md">
        <div class="card shadow p-3 mb-5 bg-white rounded" style=" height: 300px;">
          <img class="card-img-top mx-auto" src="{{ asset('dist/img/store.png') }}" style="width: 50px;">
          <div class="card-body">
            <h5 class="card-title text-center">BUAT AKUN TOKO</h5>
            <p class="card-text text-center">Register akun untuk dapat melanjutkan
  ...
  <div class="container">
    <div class="jumbotron-rusunawa" id="tentang">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 col-md-12" >
            <div class="text-left">
                ...
                <span style="font: bold, italic; color: blue">PT. Astra Internasional Tbk</span>
                selaku Distributor Resmi dari sukucadang motor Honda dengan merek SCAA ( Suku Cadang Asli Astra ) untuk wilayah Kalimantan Selatan dan Kalimantan Tengah.</p>
              </div>             
            </div>  
        </div>
      </div>  
    ...
    <div class="jumbotron-rusunawa" id="tentang">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 col-md-12" >
            <div class="text-left">
                <h3 data-aos="zoom-in-up"><b>Visi dan Misi PT. Kumala Central Partindo</b></h3>
                <div class="underline-title mr-auto" data-aos="zoom-in-up"></div>

                <ul class="beranda-syarat">
                  <li><i class="fa fa-check-circle" style="padding-right: 5px; color: green;"></i>
                  VISI : Menjadi Perusahaan Distributor Suku Cadang Roda 2 dan Roda 4 yang produknya menjadi pilihan utama konsumen di wilayah Kalimantan Selatan dan Kalimantan Tengah
                  </li> 
                  <li><i class="fa fa-check-circle" style="padding-right: 5px; color: green;"></i>
                  MISI : Menjadi Perusahaan yang memberikan pelayanan yang cepat, tanggap, lengkap dan memiliki profit yang sehat
                  </li>        
                </ul>
              </div>             
            </div>  
...
<!-- Alur-->
  <div class="jumbotron-lokasi" id="alur" style="padding-top: 50px;">
    <h3 data-aos="zoom-in-up"><b>Alur Penggunaan Aplikasi</b></h3>
    <div class="underline-title mx-auto" data-aos="zoom-in-up"></div>
        <div class="container">
            <div class="row content pb-5">
              ...
              <div class="col-md-7 pt-5 order-2 order-md-1 text-justify">
                <h3>1. Masuk Ke Website Aplikasi PT. KCP</h3>
            ...
            <div class="row content pb-5">
              ...
              <div class="col-md-7 pt-5 order-2 order-md-1 text-right">
                <h3>2. Registrasi Akun Anda</h3>
                <P style="font-size: 15px;">
                  Apabila anda belum memiliki akun, <span style="font: bold; color: red">Registrasi</span> akun anda terlebih dahulu melalui
                </P>
              </div>
            </div>
            <div class="row content pb-5">
              ...
              <div class="col-md-7 pt-5 order-2 order-md-1 text-left">
                <h3>3. Tambahkan pembelian barang Anda</h3>
                <P style="font-size: 15px;">
                    Tambahkan barang beserta stok yang anda inginkan.
                </P>
              </div>
            </div>
            <div class="row content pb-5">
                ...
                <div class="col-md-7 pt-5 order-2 order-md-1 text-right">
                  <h3>4. Pembelian Diterima</h3>
                  <P style="font-size: 15px;">
                    Barang anda akan segera dikirim dengan ekspedisi yang sudah disesuaikan dengan keperluan anda.<br>
                  </P>
                </div>          
            </div>
        </div>
...
<footer style="background-color: #4682B4; margin:0px !important;">
    ...
    <div class="row mb-3 pt-3">
      ...
      <div class="col-lg-7 text-left ">
        ...
        <div class="text footer-bawah">
          <h5><b>PT. Kumala Central Partindo</b></h5>
          <p>Jl. Sutoyo S No. 144, Kota Banjarmasin, Kalimantan Selatanl</p>
        </div>
        <div class="text footer-bawah">
  ...
  <div class="container">
    <div class="row">
    <div class="col-lg-12 text-center" style="font-size: 15px;"><span>Developed by IT Division</span> Powered by PT. KCP, 2024</div>
    </div>
  </div>
</footer> 
