                                ...
                                <table class="table table-hover table-sm bg-light table-striped" id="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Disc Nominal (%)</th>
                                    ...
                                    <tbody class="input-fields">
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="form-group col-12">
                                                            <input type="number" name="inputs[0][diskon_persen]" class="form-control" placeholder="0">
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="form-group col-12">
                                                            <input type="number" name="inputs[0][total_diskon_persen]" class="form-control" placeholder="0">
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="form-group col-12">
    ...
    <script>
        ...
        $('#add').click(function(){
            ...
            $('#table').append(`<tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="form-group col-12">
                                                            <input type="number" name="inputs[${i}][diskon_persen]" class="form-control" placeholder="0">
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="form-group col-12">
                                                            <input type="number" name="inputs[${i}][total_diskon_persen]" class="form-control" placeholder="0">
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="form-group col-12">
