                        ...
                        <table class="table table-hover table-bordered table-sm bg-light table-striped" id="example1">
                            <thead>
                                <tr style="background-color: #6082B6; color:white">
                                    ...
                                    <th class="text-center">Harga Jual/pcs</th>
                            ...
                            <tbody>
                                ...
                                @foreach($part_het as $p)
                                <tr>
                                    <td class="text-center">{{ $no++ }}</td>
                                    <td class="text-left">{{ $p->part_no }}</td>
                                    <td class="text-center">{{ $p->ready->stok }}</td>
                                    <td class="text-left">Rp. {{ number_format($p->het, 0, ',', '.') }}</td>
                                    <td class="text-center">
                                        <a class="btn btn-warning btn-sm"><i class="fas fa-times-circle"></i> </a>
                                    </td>
                                </tr>
                                @endforeach
