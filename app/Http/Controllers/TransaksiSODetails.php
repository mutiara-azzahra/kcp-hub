...
class TransaksiSODetails extends Model
{
    ...
    protected $fillable = [ 
        'noso', 'area_so', 'kd_outlet', 'part_no', 'nm_part','id_rak', 'qty', 'hrg_pcs', 'disc', 'nominal', 
        'nominal_disc', 'nominal_total', 'id_rak','qty_gudang', 'ket_gudang', 'flag_stock_tt', 'nominal_gudang', 
