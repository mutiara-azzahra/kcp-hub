...
class PembayaranController extends Controller
{
    public function index(){
        ...
        $list_belum_bayar = InvoiceNonHeader::where('flag_pembayaran', 'N')->orderBy('tanggal_nota', 'desc')->get();
        $list_sudah_bayar = InvoiceNonHeader::where('flag_pembayaran', 'Y')->orderBy('tanggal_nota', 'desc')->get();
